    ...
    <div className="farmer-section" id="farmer">
      <div className="fr-title-content">
        ...
        <p className="fr-description">
          Meet our exceptional team of specialist, dedicated to providing
          top-notch advisory services at Agrigenesis. Trust in their knowledge
          and experience to lead you towards a Profitable and Good crops.
        </p>
      </div>
