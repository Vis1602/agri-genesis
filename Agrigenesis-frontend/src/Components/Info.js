    ...
    <div className="info-section" id="services">
      <div className="info-title-content">
        ...
        <p className="info-description">
          At Agrigenesis, we empower farmers by providing a comprehensive suite
          of tools and services designed to enhance agricultural productivity
          and sustainability. Our platform connects farmers with experts,
          facilitates crop exchange and direct selling, and offers tailored
          advice to help you make informed decisions about your farm.
        </p>
      </div>
